...
for loop is (1,2*1). 
       '''
        for k in range(1,2*i):#for loop to print *
            print('*',end=' ')#print * every time loop repeat
            
        print()#for loop to print *
...
space is 4-3=1, in second row space is 4-2=2 and so on. so range is (0,row-i) '''
        for j in range(0,row-i):#for loop to print space
            print(' ', end=' ')#print space
        for j in range(1, 2*i):#for loop to print *
            print('*', end=' ')#print star every time loop repeat
        print()
